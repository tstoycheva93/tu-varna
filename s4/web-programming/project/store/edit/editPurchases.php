...
if (isset($_POST['editPurchase'])) {
    ...
    $purchaseId = $_POST['selectPurchase'];
    $clientId = $_POST['clientId'];
    $employeeId = $_POST['employeeId'];
    $newDate = $_POST['newDate'];

    $sql = "UPDATE purchases SET clientsKey = ?, employeesKey = ?, dateOf = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iisi", $clientId, $employeeId, $newDate, $purchaseId);
