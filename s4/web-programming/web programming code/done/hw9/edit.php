<?php
    ...
    $newPublisher = "Просвета";
    $currentPublisher ="Анубис";
    ...
    $sql = "UPDATE books SET publisher='$newPublisher' WHERE publisher='$currentPublisher'";
    if ($conn->query($sql) === TRUE) {
        echo "<h2>Успешно редактиране на издателство!</h2>";
