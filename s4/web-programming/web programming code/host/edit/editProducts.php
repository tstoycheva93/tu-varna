...
<form action="editProducts.php" method="post">
    ...
    <div class="form-group">
        <label for="newCount">amount:</label>
        <input type="number" name="newCount" required><br>
    </div>

    <div class="form-group">
     <input type="submit" value="submit" name="editProduct"><br>
    </div>
...
if (isset($_POST['editProduct'])) {
    ...
    $sql = "UPDATE products SET name = ?, price = ?, count = ?, groupsKey = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("siiii", $newName, $newPrice, $newCount, $groupId, $productId);
