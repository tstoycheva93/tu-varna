...
% svmStruct=svmtrain(P_train_norm',Tn,'kernel_function','rbf','rbf_sigma',1,'autoscale',false,'method','SMO','tolkkt',0.1);

svmStruct=svmtrain(P_train_norm',Tn,'kernel_function','polynomial','polyorder',4,'autoscale','false');
