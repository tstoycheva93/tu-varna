...
INSERT INTO TEACHER (teacher_id, degree_id, phone_number, teacher_email)
VALUES (1, 1, '0899877235', 'teacher1@gmail.com');

INSERT INTO TEACHER (teacher_id, degree_id, phone_number, teacher_email)
VALUES (2, 1, '0846425948', 'teacher2@gmail.com');

INSERT INTO TEACHER (teacher_id, degree_id, phone_number, teacher_email)
VALUES (3, 1, '0899874746', 'teacher3@gmail.com');

INSERT INTO TEACHER (teacher_id, degree_id, phone_number, teacher_email)
VALUES (4, 2, '0885694344', 'teacher4@gmail.com');

INSERT INTO TEACHER (teacher_id, degree_id, phone_number, teacher_email)
VALUES (5, 2, '0899543621', 'teacher5@gmail.com');

INSERT INTO TEACHER (teacher_id, degree_id, phone_number, teacher_email)
VALUES (6, 2, '0883272353', 'teacher6@gmail.com');
...
DELETE FROM TABLE DEGREE WHERE DEGREE_ID = 1;

UPDATE TABLE DEGREE
SET DEGREE_NAME = 'none' 
WHERE DEGREE_ID = 1;

DELETE FROM TABLE MAJOR WHERE MAJOR_ID = 3;

UPDATE TABLE MAJOR 
SET MAJOR_NAME = 'TTT'
WHERE MAJOR_ID = 3;

DELETE FROM TABLE MARKS WHERE STUDENT_ID = 1;

UPDATE TABLE MARKS 
SET marks = 4.70
WHERE student_id = 40;

DELETE FROM TABLE STUDENTS WHERE STUDENT_ID = 20;

UPDATE TABLE STUDENTS 
SET student_name = 'Marko'
WHERE student_id = 14;

DELETE FROM TABLE STUDENT_SUBJECT WHERE student_id = 19;

UPDATE TABLE SUTDENT_SUBJECT 
SET subject_id = 4
WHERE student_id = 9;
...
SET subject_name = 'Design'
WHERE subject_id = 6;

DELETE FROM TABLE TEACHER WHERE TEACHER_ID = 6;

UPDATE TABLE TEACHER
SET teacher_email = 'dekan001@abv.bg'
WHERE teacher_id = 4;

DELETE FROM TABLE TEACHER_SUBJECT WHERE subject_id = 1;

UPDATE TABLE TEACHER_SUBJECT 
SET subject_id = 5
WHERE teacher_id = 6;